...
The timer will run as soon as the first screen has started and does not consider how long a user may wait until he clicks the next button on the \nameref{sec:screens-start} or \nameref{sec:screens-message} screen.
...
This is an overlay version of the \nameref{sec:screens-chatbot} screen, that can be opened and closed via a button.
